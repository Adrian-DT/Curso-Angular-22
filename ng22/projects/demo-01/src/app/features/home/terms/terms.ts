...
@Component({
  ...
  <div class="demo-section">
    ...
    <ind-check [label]="labelTerms()" [checked]="isAceptedTerms()" (emitCheckedChange)="toggleAceptedTerms($event)" />
  ...
  <div>
    <ind-check [label]="labelNotifications()" [checked]="isAceptedNotifications()" (emitCheckedChange)="toggleAceptedNotifications($event)" />
    <p>
